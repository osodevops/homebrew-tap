class KafkaBackupEnterprise < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/osodevops/kafka-backup-enterprise/releases/download/v0.2.0/kafka-backup-aarch64-macos.tar.gz"
      sha256 "03090b0a884d694617720504da7a2119197f0e9aa149bcec80f7ce8d2fe7f194"
    end
    if Hardware::CPU.intel?
      url "https://github.com/osodevops/kafka-backup-enterprise/releases/download/v0.2.0/kafka-backup-x86_64-macos.tar.gz"
      sha256 "acfbb9ec4678573ecaa22b049622dcbe5dd7c9d7cd41362c28bc8c17ca91b66d"
    end
  end
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/osodevops/kafka-backup-enterprise/releases/download/v0.2.0/kafka-backup-x86_64-linux.tar.gz"
